...
export class InitialSchema1765773826067 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "public"."idx_seat_status_trip_state"`);
        await queryRunner.query(`DROP INDEX "public"."idx_seat_layouts_capacity"`);
        await queryRunner.query(`DROP INDEX "public"."idx_routes_analytics_covering"`);
        await queryRunner.query(`DROP INDEX "public"."idx_trips_departure_route"`);
        await queryRunner.query(`DROP INDEX "public"."idx_trips_route_bus_departure"`);
        await queryRunner.query(`DROP INDEX "public"."idx_trips_departure_bus"`);
        await queryRunner.query(`DROP INDEX "public"."idx_trips_date_route_analytics"`);
        await queryRunner.query(`DROP INDEX "public"."idx_trips_active_recent"`);
        await queryRunner.query(`DROP INDEX "public"."idx_bookings_contact_email"`);
        await queryRunner.query(`DROP INDEX "public"."idx_bookings_contact_phone"`);
        await queryRunner.query(`DROP INDEX "public"."idx_bookings_last_modified_at"`);
        await queryRunner.query(`DROP INDEX "public"."idx_booking_reference_unique"`);
        await queryRunner.query(`DROP INDEX "public"."idx_bookings_booked_at_status"`);
        await queryRunner.query(`DROP INDEX "public"."idx_bookings_status_amount_date"`);
        await queryRunner.query(`DROP INDEX "public"."idx_bookings_trip_status_date"`);
        await queryRunner.query(`DROP INDEX "public"."idx_bookings_analytics_composite"`);
        await queryRunner.query(`DROP INDEX "public"."idx_bookings_summary_covering"`);
        await queryRunner.query(`DROP INDEX "public"."idx_bookings_date_status_analytics"`);
        await queryRunner.query(`DROP INDEX "public"."idx_bookings_paid_recent"`);
        ...
        await queryRunner.query(`ALTER TABLE "seat_layouts" ADD "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "seat_layouts" DROP COLUMN "updated_at"`);
        await queryRunner.query(`ALTER TABLE "seat_layouts" ADD "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "operators" DROP COLUMN "approved_at"`);
        await queryRunner.query(`ALTER TABLE "operators" ADD "approved_at" TIMESTAMP WITH TIME ZONE`);
        await queryRunner.query(`ALTER TABLE "route_points" DROP COLUMN "createdAt"`);
        await queryRunner.query(`ALTER TABLE "route_points" ADD "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "route_points" DROP COLUMN "updatedAt"`);
        await queryRunner.query(`ALTER TABLE "route_points" ADD "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "routes" DROP COLUMN "createdAt"`);
        await queryRunner.query(`ALTER TABLE "routes" ADD "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "routes" DROP COLUMN "updatedAt"`);
        await queryRunner.query(`ALTER TABLE "routes" ADD "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "feedbacks" DROP COLUMN "submitted_at"`);
        await queryRunner.query(`ALTER TABLE "feedbacks" ADD "submitted_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "trips" DROP COLUMN "base_price"`);
        await queryRunner.query(`ALTER TABLE "trips" ADD "base_price" integer NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "payments" ADD "processed_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "notifications" DROP COLUMN "sent_at"`);
        await queryRunner.query(`ALTER TABLE "notifications" ADD "sent_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        ...
        await queryRunner.query(`ALTER TABLE "bookings" ADD "booking_reference" character varying NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "bookings" ADD "total_amount" integer NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "bookings" ADD "booked_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "bookings" DROP COLUMN "cancelled_at"`);
        await queryRunner.query(`ALTER TABLE "bookings" ADD "cancelled_at" TIMESTAMP WITH TIME ZONE`);
        await queryRunner.query(`ALTER TABLE "payment_methods" DROP COLUMN "created_at"`);
        await queryRunner.query(`ALTER TABLE "payment_methods" ADD "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "refresh_tokens" DROP COLUMN "expiresAt"`);
        await queryRunner.query(`ALTER TABLE "refresh_tokens" ADD "expiresAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
