...
export class AddFacebookIdToUsers1766353634464 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "facebookId" character varying`);
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "UQ_f9740e1e654a5daddb82c60bd75" UNIQUE ("facebookId")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "idx_users_facebook_id" ON "users" ("facebookId")`);
    }
