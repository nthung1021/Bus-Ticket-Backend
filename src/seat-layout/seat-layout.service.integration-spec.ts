...
import { SeatLayout, SeatLayoutType } from '../entities/seat-layout.entity';
...
describe('SeatLayoutService (integration)', () => {
    ...
    // We need userRepository if we were doing cleanups via user queries in a standardized way
    // but here we can just use any repo to execute the raw query.
    ...
    beforeEach(async () => {
        // Cleanup with raw SQL for consistency
